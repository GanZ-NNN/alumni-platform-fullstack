...
class _AdminDashboardState extends State<AdminDashboard>
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              children: [
                Icon(
                  icon,
                  color: isSelected ? Colors.blue[400] : Colors.blueGrey[400],
                  size: 22,
                ),
                const SizedBox(width: 16),
                Expanded(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(
                'Welcome back, ${widget.adminUser.firstName}',
                style: TextStyle(
                  fontSize: 14,
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items:
              ['2024', '2025', '2026'].map((String value) {
  ...
  TableRow _tableDataRow() {
    return TableRow(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 16),
          child: _buildStatusBadge('Completed', Colors.green),
        ),
      ],
    );
  }
  ...
  Widget _buildDynamicContent() {
    switch (_selectedMenu) {
      ...
      case 'Manage News':
        return ManageNewsScreen(adminId: widget.adminUser.id);
      case 'Manage Jobs':
      ...
      case 'Notifications':
        return const ManageNotificationsScreen();
      case 'Approvals':
        return const ManageUsersScreen(showOnlyPending: true);
      default:
      ...
      child: Column(
        children: [
          CircleAvatar(
            radius: 40,
            backgroundColor: Colors.blue[50],
            child: Icon(Icons.speed_rounded, size: 40, color: Colors.blue[700]),
          ),
          ...
          const Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('CPU Usage', style: TextStyle(fontFamily: 'Google Sans')),
              Text(
                '12%',
                style: TextStyle(
                  color: Colors.green,
