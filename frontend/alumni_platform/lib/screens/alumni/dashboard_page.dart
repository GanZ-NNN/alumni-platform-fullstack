...
class _AlumniDashboardPageState extends State<AlumniDashboardPage> {
  ...
  Map<String, dynamic> _stats = {'totalAlumni': 0, 'totalJobs': 0, 'totalPosts': 0};
  ...
  Widget _buildStatGrid() {
    return Padding(
      ...
      child: GridView.count(
        ...
        children: [
          _buildStatCard('ສິດເກົ່າທັງໝົດ', _stats['totalAlumni'].toString(), Icons.people, Colors.blue),
          _buildStatCard('ວຽກທີ່ເປີດຮັບ', _stats['totalJobs'].toString(), Icons.work, Colors.green),
          _buildStatCard('ກິດຈະກຳ', _stats['totalPosts'].toString(), Icons.calendar_month, Colors.purple),
          _buildStatCard('ຜົນງານດີເດັ່ນ', '89', Icons.workspace_premium, Colors.orange),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildDeptCard(item['major'], '${item['count']} ນັກສຶກສາ', Colors.blue);
        },
      ),
    );
  }
  ...
  Widget _buildSuccessCard() {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFF1A56BE), borderRadius: BorderRadius.circular(20)),
